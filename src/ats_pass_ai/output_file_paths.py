...
PATHS = {
    ...
    "personal_information_extraction_task": f"{info_extraction}/personal_information_extraction_task.txt",
    ...
    "ats_friendly_skills_pre_task": f"{pre_tasks}/ats_friendly_skills_pre_task.txt",
