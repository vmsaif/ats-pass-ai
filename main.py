...
def main():
    ...
    run_poetry_project(project_a_path, info_collection)
...
def startFresh(delete_latex_files: bool = False, 
               deleteDB: bool = False, 
...
def run_poetry_project(project_path, command):
    ...
    process = subprocess.run(f"poetry run {command}", shell=True)
